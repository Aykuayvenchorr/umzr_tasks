...
@register.simple_tag
def get_license_facilities(license_id):
...
@register.simple_tag
def get_license_projects(license_id):
    return Project.actual_projects.filter(licenses=license_id).order_by('name')

@register.simple_tag
def get_division_projects(division_id):
...
@register.inclusion_tag('includes/card_project_tag.html', takes_context=True)
def card_project_tag(context, id_prj): 
    project = Project.objects.get(id=id_prj)
    context = {
        'user':             context['user'],
        'project':          project,
    }
...
@register.inclusion_tag('includes/block_company_header_tag.html', takes_context=True)
def block_company_header_tag(context, id): 
...
@register.inclusion_tag('includes/block_company_ul_tag.html', takes_context=True)
def block_company_ul_tag(context, id): 
    company = Company.objects.get(id=id)
    context = {
        'user':             context['user'],
        'company':          company,
...
@register.inclusion_tag('includes/block_company_logo_tag.html', takes_context=True)
def block_company_logo_tag(context, id): 
    company = Company.objects.get(id=id)
    context = {
        'user':             context['user'],
        'company':          company,
...
@register.inclusion_tag('includes/block_division_header_tag.html', takes_context=True)
def block_division_header_tag(context, id): 
...
@register.inclusion_tag('includes/block_division_ul_tag.html', takes_context=True)
def block_division_ul_tag(context, id): 
    division = Division.objects.get(id=id)
    context = {
        'user':             context['user'],
        'division':         division,
...
@register.inclusion_tag('includes/block_license_header_tag.html', takes_context=True)
def block_license_header_tag(context, id): 
...
@register.inclusion_tag('includes/block_license_ul_tag.html', takes_context=True)
def block_license_ul_tag(context, id): 
    license = License.objects.get(id=id)
    context = {
        'user':             context['user'],
        'license':          license,
...
@register.inclusion_tag('includes/block_license_doc_tag.html', takes_context=True)
def block_license_doc_tag(context, id): 
    license = License.objects.get(id=id)
    context = {
        'user':             context['user'],
        'license':          license,
