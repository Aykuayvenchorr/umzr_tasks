...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='bptask',
            name='bps',
            field=models.ForeignKey(help_text='Строка бизнес плана', on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='app_econ.businessplanstr', verbose_name='Строка'),
        ),
        migrations.AddIndex(
            model_name='project',
